 ...
 *   <li>A <strong>Protocol V2 messageId</strong> (format: {@code <version>:<groupId>:<sequenceId>})
 ...
 * boolean sessionIsActive = tracker.hasActiveToken("2:user-123:session-A");
 * }</pre>
 *
 * @author Frank KOSSI
 * @since 2.0.0
...
public interface TokenTracker {
     ...
     *   <li>If it is a <strong>Protocol V2 messageId</strong> (starts with the version
     *       prefix, e.g., {@code "2:"}), the specific sequence is checked directly.</li>
     ...
     * </ol>
     *
     * @param target a groupId string, a signed token, or a Protocol V2 messageId;
