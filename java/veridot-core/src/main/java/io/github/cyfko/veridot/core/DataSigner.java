...
public interface DataSigner {
    ...
    interface Configurer {
         ...
         * Maps to the {@code groupId} field in the Protocol V3 {@code messageId}.
         *
         ...
         * Maps to the {@code sequenceId} field in the Protocol V3 {@code messageId}.
         *
     ...
     *   <li>{@link DistributionMode#INDIRECT} — returns the Protocol V3 {@code messageId}
