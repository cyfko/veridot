...
verification metaasata across nodes. It defines the wire format,
...
distributing public-key verification metaasata, authorization
...
> **Note:** There is NO NATIVE mode. The DIRECT mode covers the
...
| `0x04` | metaasata    | `bytes`  | No       | Opaque session metaasata                       |
