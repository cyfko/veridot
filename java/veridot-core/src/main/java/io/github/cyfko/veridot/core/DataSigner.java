 ...
 * the associated <em>verification metadata</em> to a {@link MetadataBroker} so that any service
...
public interface DataSigner {
    ...
    interface Configurer {
         ...
         * Maps to the {@code groupId} field in the Protocol V2 {@code messageId}.
         *
         ...
         * Maps to the {@code sequenceId} field in the Protocol V2 {@code messageId}.
         *
     ...
     * key material and TTL) is simultaneously published to the underlying {@link MetadataBroker}
     ...
     *   <li>{@link DistributionMode#INDIRECT} — returns the Protocol V2 {@code messageId}
